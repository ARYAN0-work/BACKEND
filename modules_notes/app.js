...
const name = require('./5-utils')// as a parameter we need to pass where the data is coming from=> where module is located// wrong
console.log(names);//// it will give a object jhon jhon peter peter
